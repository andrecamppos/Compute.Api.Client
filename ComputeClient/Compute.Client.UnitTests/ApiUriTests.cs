...
namespace Compute.Client.UnitTests
{
    ...
    public class ApiUriTests
    {
        ...
        public void ReturnsGetDomainNatRulesUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/network/natRule?networkDomainId="+networkDomainId, uri.OriginalString);
        }
        ...
        public void ReturnsGetNatRuleUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/network/natRule/"+ networkId, uri.OriginalString);
        }
        ...
        public void ReturnsCreateNatRuleUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/network/createNatRule", uri.OriginalString);
        }
        ...
        public void ReturnsDeleteNatRuleUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/network/deleteNatRule", uri.OriginalString);
        }
        ...
        public void ReturnsCreatePoolUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/createPool", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolsUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/pool", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/pool/"+ poolId, uri.OriginalString);
        }
        ...
        public void ReturnsEditPoolUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/editPool", uri.OriginalString);
        }
        ...
        public void ReturnsDeletePoolUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/deletePool", uri.OriginalString);
        }
        ...
        public void ReturnsAddPoolMemberUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/addPoolMember", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolMembersUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/poolMember", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolMemberUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/poolMember/"+ memberId, uri.OriginalString);
        }
        ...
        public void ReturnsEditPoolMemberUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/editPoolMember", uri.OriginalString);
        }
        ...
        public void ReturnsDeletePoolMemberUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/removePoolMember", uri.OriginalString);
        }
        ...
        public void ReturnsAddVipNodeUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/createNode", uri.OriginalString);
        }
        ...
        public void ReturnsGetVipNodesUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/node", uri.OriginalString);
        }
        ...
        public void ReturnsGetVipNodeUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/node/"+ nodeId, uri.OriginalString);
        }
        ...
        public void ReturnsEditVipNodeUri()
        {
            ...
            Assert.AreEqual(ApiUris.MCP2_9_PREFIX + _orgId + "/networkDomainVip/editNode", uri.OriginalString);
        }
