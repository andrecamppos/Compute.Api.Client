...
namespace DD.CBU.Compute.Api.Client
{
    ...
    public static class ApiUris
    {
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/user/createUser", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/user/editUser", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/user/setUserRoles", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/user/changeUserPassword", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/user/deleteUser", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/createSnapshotPreviewServer", orgId), UriKind.Relative);
        }
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/createReplicatedSnapshotPreviewServer", orgId), UriKind.Relative);
		}
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/networkDomain", orgId), UriKind.Relative);
        }
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/staticRoute", orgId), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/createStaticRoute", orgId), UriKind.Relative);
		}
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deleteStaticRoute", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/restoreStaticRoutes", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(
                string.Format(MCP2_10_PREFIX + "{0}/network/networkDomain/{1}", orgId, networkDomainId),
                UriKind.Relative);
        }
        ...
        {
            return new Uri(
                String.Format(MCP2_10_PREFIX + "{0}/server/addNic", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(
                String.Format(MCP2_10_PREFIX + "{0}/server/exchangeNicVlans", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/removeNic", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/nic?vlanId={1}", orgId, vlanId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/notifyNicIpChange", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deployNetworkDomain", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/editNetworkDomain", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deleteNetworkDomain", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/deployServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/infrastructure/datacenter", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(
                string.Format(MCP2_10_PREFIX + "{0}/image/cleanCustomerImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(
                string.Format(MCP2_10_PREFIX + "{0}/image/deleteCustomerImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/copyImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/editServerMetadata", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/server", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri((MCP2_10_PREFIX + $"{orgId}/infrastructure/snapshotWindow?datacenterId={datacenterId}&servicePlan={servicePlan}"), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/server/{1}", orgId, serverId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/antiAffinityRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/antiAffinityRule?serverId={1}", orgId, serverId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/antiAffinityRule?networkId={1}", orgId, networkId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/antiAffinityRule?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/firewallRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/firewallRule/{1}", orgId, firewallRuleId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/createFirewallRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/editFirewallRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deleteFirewallRule", orgId), UriKind.Relative);
        }
        ...
        {
	        return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/firewallRuleStatistics", orgId), UriKind.Relative);
        }
		...
		public static Uri GetVlan(Guid orgId, Guid id, string vlanName, Guid networkDomainId)
        {
            ...
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/vlan?{1}", orgId, String.Join("&", queryParameters)), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/vlan/{1}", orgId, vlanId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/vlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deployVlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/editVlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/attachVlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/detachVlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/expandVlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deleteVlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/exportHistory", organizationId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/importImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/exportImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/ovfPackage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/exportInProgress", orgId), UriKind.Relative);
        }
        #endregion
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/enableServerMonitoring", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/changeServerMonitoringPlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/disableServerMonitoring", orgId), UriKind.Relative);
        }
        ...
        {
            var url = string.Format(MCP2_10_PREFIX + "{0}/report/monitoringUsageReport?startDate={1}", orgId, startDate.ToString("yyyy-MM-dd"));
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/addPublicIpBlock", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/publicIpBlock?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/publicIpBlock/{1}", orgId, publicIpBlockId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservedPublicIpv4Address?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservedPublicIpv4Address?networkId={1}", orgId, networkId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservedPrivateIpv4Address?vlanId={1}", orgId, vlanId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservedPrivateIpv4Address?networkId={1}", orgId, networkId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/deleteServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/startServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/resetServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/rebootServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/shutdownServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/powerOffServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/updateVmwareTools", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/upgradeVirtualHardware", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/natRule?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/natRule/{1}", orgId, natRuleId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/createNatRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deleteNatRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/createPool", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/pool", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/pool/{1}", orgId, poolId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/editPool", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/deletePool", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/addPoolMember", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/poolMember", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/poolMember/{1}", orgId, poolMemberId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/editPoolMember", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/removePoolMember", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/createNode", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/node", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/node/{1}", orgId, vipNodeId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/editNode", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/deleteNode", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/createVirtualListener", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/virtualListener", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/virtualListener/{1}", orgId, virtualListenerId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/editVirtualListener", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/deleteVirtualListener", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/defaultHealthMonitor?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/defaultPersistenceProfile?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/networkDomainVip/defaultIrule?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/removePublicIpBlock", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/cleanServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/moveServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/copyServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/report/osUnitsUsageReport?startDate={1:yyyy-MM-dd}&endDate={2:yyyy-MM-dd}", orgId, startDate, endDate), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/report/snapshotUsageReport?startDate={1:yyyy-MM-dd}&endDate={2:yyyy-MM-dd}", orgId, startDate, endDate), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/report/securityGroupUsageReport?startDate={1:yyyy-MM-dd}&endDate={2:yyyy-MM-dd}", orgId, startDate, endDate), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/report/drsPairsUsageReport?startDate={1:yyyy-MM-dd}&endDate={2:yyyy-MM-dd}", orgId, startDate, endDate), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/osImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/osImage/{1}", orgId, imageId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/customerImage", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/customerImage/{1}", orgId, imageId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/editImageMetadata", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/image/moveCustomerImage", orgId), UriKind.Relative);
        }
        ...
        {
            return
                new Uri(string.Format(MCP2_10_PREFIX + "{0}/infrastructure/operatingSystem", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/createSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/editSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/deleteSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/addNicToSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/addServerToSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/removeServerFromSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/removeNicFromSecurityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/securityGroup?vlanId={1}", orgId, vlanId),
                UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/securityGroup?serverId={1}", orgId, serverId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/securityGroup/securityGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/createIpAddressList", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/ipAddressList?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/ipAddressList/{1}", orgId, ipAddressListId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/editIpAddressList", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deleteIpAddressList", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/createPortList", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/portList?networkDomainId={1}", orgId, networkDomainId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/portList/{1}", orgId, portListId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/editPortList", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/deletePortList", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/addDisk", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/removeDisk", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservePrivateIpv4Address", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/unreservePrivateIpv4Address", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reserveIpv6Address", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservedIpv6Address", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/unreserveIpv6Address", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/reservedPrivateIpv4Address", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/createTagKey", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/tagKey", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/tagKey/{1}", orgId, tagKeyId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/editTagKey", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/deleteTagKey", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/applyTags", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/tag", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/tag/removeTags", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/cleanConsistencyGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/createConsistencyGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/snapshot", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/stopPreviewSnapshot", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/startPreviewSnapshot", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/deleteConsistencyGroup", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/initiateFailover", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/consistencyGroup/expandJournal", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/deployUncustomizedServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/cloneServer", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/setNicConnectivity", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/enableSnapshotService", orgId), UriKind.Relative);
        }
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/enableReplication", orgId), UriKind.Relative);
		}
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/changeSnapshotServicePlan", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/editSnapshotMetadata", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/editSnapshotServiceScripts", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/disableSnapshotService", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/disableReplication", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/initiateManualSnapshot", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/deleteManualSnapshot", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/changeNetworkAdapter", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/createAntiAffinityRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/deleteAntiAffinityRule", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/user/myUser", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/user/user/{userName}", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/user/user", UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/addScsiController", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/removeScsiController", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/removeIsoFile", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/server/removeFlpFile", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/sslDomainCertificate/{sslDomainCertificateId}", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/sslDomainCertificate", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/sslCertificateChain/{sslCertificateChainId}", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/sslCertificateChain", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/sslOffloadProfile/{sslOffloadProfileId}", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/sslOffloadProfile", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/importSslDomainCertificate", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/importSslCertificateChain", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/createSslOffloadProfile", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/editSslOffloadProfile", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/deleteSslDomainCertificate", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/deleteSslCertificateChain", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/networkDomainVip/deleteSslOffloadProfile", UriKind.Relative);
        }
        ...
        { 
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/snapshot/restoreFromSnapshot", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/infrastructure/geographicRegion", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/infrastructure/geographicRegionProperties", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/organization/setTwoFactorAuthentication", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}{orgId}/server/changeDiskIops", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}{orgId}/server/expandDisk", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}{orgId}/server/changeDiskSpeed", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}{orgId}/infrastructure/osUnitsGroup", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}{orgId}/infrastructure/osUnitsGroup/{osUnitsGroupId}", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/server/server", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/server/server/{serverId}", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/organization/organization", UriKind.Relative);
        }
        ...
        {
            return new Uri($"{MCP2_10_PREFIX}/{orgId}/organization/setVpnAccess", UriKind.Relative);
        }
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/snatExclusion", orgId), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/restoreSnatExclusions", orgId), UriKind.Relative);
		}
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/removeSnatExclusion", orgId), UriKind.Relative);
        }
        ...
        {
            return new Uri(string.Format(MCP2_10_PREFIX + "{0}/network/addSnatExclusion", orgId), UriKind.Relative);
        }
		...
		{
			return new Uri(string.Format(MCP2_10_PREFIX + "{0}/user/duoStatus/{1}", orgId, userName), UriKind.Relative);
		}
